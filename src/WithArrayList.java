...
public class WithArrayList {
  ...
  public static void main (String[] args) {
    ...
    studentList.add(new Studentlist("Sujit", 1));
    studentList.add(new Studentlist("Siddharth", 2));
    studentList.add(new Studentlist("Karanpreet", 3));
...
class Studentlist{
  ...
  public Studentlist(String name, int rollNumber) {
    this.name = name;
