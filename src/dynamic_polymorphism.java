class Student20 {
  ...
  public Student20(String name, int year) {
    this.name       = name;
    this.year       = year;
  }
  ...
  public float computeFees () {
    return Student20.annualFees * year;
  }
  public float computeFees (int annualFees){return annualFees*this.year;}
}

class ResearchStudent20 extends Student20 {
  private String researchArea;
  private static final int annualFees = 10000;

  public ResearchStudent20(String name, int year, String researchArea) {
    super(name, year);
...
public class dynamic_polymorphism {
  public static void main(String[] a) {
    ...
    Student20 s1 = new Student20("karan", 2);
    System.out.println(s1.getDetails());
    System.out.println(s1.computeFees());
    Student20 s2 = new ResearchStudent20("siddharth", 3, "Software Engineering");
