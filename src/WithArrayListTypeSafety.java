...
public class WithArrayListTypeSafety {
  ...
  public static void main (String[] args) {
    ...
    studentList.add(new Studentsaf("Sujit", 1));
    studentList.add(new Studentsaf("Siddharth", 2));
    studentList.add(new Studentsaf("Karanpreet", 3));
    studentList.add("Hari");   // this would lead to runtime type error 
    studentList.add(new Studentsaf("Tricha", 4));
    printStudentList(studentList);
  }

  public static void printStudentList(ArrayList students) {
    for(Object o : students) {
      Studentsaf s = (Studentsaf) o;
...
class Studentsaf {
  ...
  public Studentsaf(String name, int rollNumber) {
    this.name = name;
