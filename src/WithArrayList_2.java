...
public class WithArrayList_2 {
  ...
  public static void main (String[] args) {
    ...
    studentList.add(new Studentlist_2("Sujit", 1));
    studentList.add(new Studentlist_2("Siddharth", 2));
    studentList.add(new Studentlist_2("Karanpreet", 3));

    studentList.add(new Studentlist_2("Tricha", 4));
    printStudentList(studentList);
  }

  public static void printStudentList(ArrayList students) {
    for(Object o : students) {
      Studentlist_2 s = (Studentlist_2) o;
...
class Studentlist_2 {
  ...
  public Studentlist_2(String name, int rollNumber) {
    this.name = name;
